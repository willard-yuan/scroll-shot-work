	...
	plans: [
		{
			name: 'iPhone',
			price: 'Pro',
			subtitle: 'Capture a whole page in one keystroke',
			features: [
				'Unlock the fastest automatic workflow',
				'Automatic stitching from recordings',
				'All theme colors',
		...
		},
		{
			...
			subtitle: 'Capture a whole page in one keystroke',
			features: [
				'Auto-stitched scroll capture — up to 30,000px',
				'OCR + translate to 30+ languages, in place',
				'19+ annotation tools, all native',
				'Record & edit video without leaving the app',
			],
			badge: 'Free Trial',
			button: {
				label: 'Get Download Free Trial',
